...
from system_definitions import (
    IrreversableStates,
    IrreversableControlElements,
    IrreversableAlgebraicStates,
    IrreversableSystem,
    FlowInSensor,
    FlowOutSensor,
...
initial_states = IrreversableStates(V=0.0, A=0.0, B=0.0)

# Initial values for the control elements.
initial_controls = IrreversableControlElements(F_in=0.0)

# Initial values for algebraic states (can be placeholders, they are calculated).
initial_algebraic = IrreversableAlgebraicStates(F_out=0.0)
...
irreversable_system = IrreversableSystem(

...
if __name__ == '__main__':
    ...
    normal_system.extend_controller_trajectory("F_cat").hold(100,9.0) 
    normal_system.step(12 * Unit("hour"))

    # cycle 1
    normal_system.extend_controller_trajectory("pM1").hold(3600., 650)
    ...
    #normal_system.extend_controller_trajectory("pM1").hold(3600., 700)
    normal_system.extend_controller_trajectory("F_cat").ramp(-3.0, ramprate = 1/3600.) # ramp dow 2 kg over 2 hours
    normal_system.step(12 * Unit("hour"))
    # cycle 2
    normal_system.extend_controller_trajectory("pM1").hold(3600., 650)
    normal_system.step(6 * Unit("hour"))

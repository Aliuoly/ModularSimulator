...
def plot(system: System) -> None:
    ...
    to_hours(ax2, history["pM1.sp"], label="SP pM1", line_kwargs={"color": "tab:red", "linestyle": "--"})
    ...
    to_hours(ax2, history["rM2.sp"], label="SP rM2", line_kwargs={"color": "tab:red", "linestyle": "--"})
    ...
    to_hours(ax2, history["rH2.sp"], label="SP rH2", line_kwargs={"color": "tab:red", "linestyle": "--"})
    ...
    ax = axes[3]
    to_hours(ax, history["mass_prod_rate"], label="Prod Rate", line_kwargs={"color": "royalblue", "alpha": 0.5})
    to_hours(ax, history["filtered_mass_prod_rate"], label="filtered Prod Rate", line_kwargs={"color": "green"})
    to_hours(ax, history["filtered_mass_prod_rate.sp"], label="SP Prod Rate", line_kwargs={"color": "tab:green", "linestyle": "--"})
    ...
    to_hours(ax, history["inst_MI"], label="inst MI", line_kwargs={"color": "tab:red", "linestyle": ":"})
    to_hours(ax, history["cumm_MI.sp"], label="SP MI", line_kwargs={"color": "tab:red", "linestyle": "--"})
    to_hours(ax, history["inst_MI.sp"], label="SP inst", line_kwargs={"color": "tab:green", "linestyle": "--"})
    to_hours(ax, history["lab_MI"], label="lab MI", line_kwargs={"color": "tab:blue", "scaley":False}, style="step")
    ...
    to_hours(ax, history["inst_density"], label="inst density", line_kwargs={"color": "tab:red", "linestyle": ":"})
    to_hours(ax, history["cumm_density.sp"], label="SP cumm", line_kwargs={"color": "tab:red", "linestyle": "--"})
    to_hours(ax, history["inst_density.sp"], label="SP inst", line_kwargs={"color": "tab:green", "linestyle": "--"})
    to_hours(ax, history["lab_density"], label="lab density", line_kwargs={"color": "tab:blue"}, style="step")
    ...
    ax = axes[6]
    to_hours(ax, history["cat_inventory"], label="cat inventory", line_kwargs={"color": "tab:orange"})
    to_hours(ax, history["cat_inventory.sp"], label="SP", line_kwargs={"color": "tab:red", "linestyle": "--"})
    ax.set_title("Catalyst Inventory")
    ax.grid(True, alpha=0.3)
    ax.legend(loc="best")

    ax = axes[7]
    to_hours(ax, history["filtered_pressure"], label="filtered Pressure", line_kwargs={"color": "green"})
    to_hours(ax, history["pressure"], label="Pressure", line_kwargs={"color": "tab:blue", "alpha": 0.5})
    ax2 = ax.twinx()
    ...
    to_hours(ax2, history["bed_level.sp"], label="bed_level SP", line_kwargs={"color": "tab:red", "linestyle": "--"})

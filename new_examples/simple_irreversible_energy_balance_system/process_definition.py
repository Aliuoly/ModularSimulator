...
class EnergyBalanceProcessModel(ProcessModel):
    ...
    gas_constant: Annotated[float, CONSTANT(unit="J/(mol*K)", description="ideal gas constant")]=8.314
    Cv: Annotated[float, CONSTANT(unit=Unit("L")**0.5/Unit("s"), description="outlet valve coefficient")]=2.0
    ...
    rho_cp: Annotated[float, CONSTANT(unit="J/(L*K)", description="heat capacity of reactor contents")]=4000.0
    overall_heat_transfer_coefficient: Annotated[
        float,
        CONSTANT(unit="J/(s*K*L**2)", description="overall heat transfer coefficient"),
    ]=500000.0
    ...
    jacket_rho_cp: Annotated[float, CONSTANT(unit="J/(L*K)", description="jacket heat capacity")]=3200.0

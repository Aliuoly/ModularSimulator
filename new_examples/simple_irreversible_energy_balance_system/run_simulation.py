...
def plot(system: System) -> None:
    ...
    plot_in_hours = partial(plot_triplet_series, time_converter=lambda t: t / second(day(1)) * 24)
...
if __name__ == "__main__":
    ...
    system.extend_controller_sp_trajectory("B").step(0.1).hold(duration=day(0.5)).step(0.1)

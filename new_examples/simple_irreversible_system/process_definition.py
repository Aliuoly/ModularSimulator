...
class IrreversibleProcessModel(ProcessModel):
    ...
    Cv: Annotated[float, M(type=T.CONSTANT, unit=SQRT_L_PER_S, description="outlet valve constant")] = 1e-1
    CA_in: Annotated[float, M(type=T.CONSTANT, unit="mol/L", description="inlet A concentration")] = 1.0

...
class GasPhaseReactorProcessModel(ProcessModel):
    ...
    n_comonomer: Annotated[float, DIFFERENTIAL(unit="mol", description="mols of comonomer")] = 800 * 0.13
    n_total: Annotated[float, DIFFERENTIAL(unit="mol", description="total mols of gas")] = 800.
    effective_cat: Annotated[
        float, 
        DIFFERENTIAL(
            unit="kg/h", 
            description="effective catalyst feed rate for production rate calculation"
            )
        ] = 6.0
    ...
    monomer_rates: Annotated[
        ...
        ALGEBRAIC(
            unit = "kmol/s", 
            description = "consumption rate of monomer and comonomer"
        )
    ] = Field(
        default_factory=lambda: np.zeros(2, dtype=np.float64)
    )
    mass_prod_rate: Annotated[float, ALGEBRAIC(unit="kg/hr", description="mass production rate")] = 0.0
    ...
    monomer_mw: Annotated[float, CONSTANT(unit="kg/kmol", description="molar weight of monomer")] = 28.0
    comonomer_mw: Annotated[float, CONSTANT(unit="kg/kmol", description="molar weight of comonomer")]  = 56.0
    cat_productivity: Annotated[float, CONSTANT(unit="1/hour", description="kinda like a rate constant")] = 9000.0
    ...
    temperature: Annotated[float, CONSTANT(unit="K", description="reaction temperature")] = 85.0 + 273.0
    reactivity_ratio_1: Annotated[float, CONSTANT(unit="", description="see 'copolymer equation'")] = 8.0
    reactivity_ratio_2: Annotated[float, CONSTANT(unit="", description="see 'copolymer equation'")] = 0.01
    ...
    def differential_rhs(
        ...
        F_m1 = u[u_map["F_m1"]] / monomer_mw / 3600. # from kg/h to kmol/s
        F_m2 = u[u_map["F_m2"]] / comonomer_mw / 3600.  # from kg/h to kmol/s

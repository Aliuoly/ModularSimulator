...
from modular_simulation.utils.wrappers import second, hour, per_hour
...
if __name__ == '__main__':
    ...
    ploter(ax, history["F_m1"], label="F_m1",
    ...
    ax = axes[2]
    ploter(ax, history["pM1"], label="pM1",
                        line_kwargs={"color": "tab:orange"}, 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ploter(ax, history["pM1.sp"], label="SP pM1",
    ...
    ax.legend(lns1, labs1, loc="best")
        ...
        # (F_m2, rM2)
    ax = axes[1]
    ploter(ax, history["F_m2"], label="F_m2",
                        line_kwargs={"color": "tab:blue"}, 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ax.set_title("F_m2")
    ax.set_ylabel("F_m2")
    ...
    ax = axes[3]
    ploter(ax, history["rM2"], label="rM2",
                        line_kwargs={"color": "tab:orange"}, style='step', 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ploter(ax, history["rM2.sp"], label="SP rM2",
                        line_kwargs={"color": "tab:red", "linestyle": "--"}, 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ax.set_title("rM2")
    ax.set_ylabel("rM2")
    ...
    ax = axes[4]
    ploter(ax, history["mass_prod_rate"], label="Prod Rate",
    ...
    ax.legend(lns1, labs1, loc="best")
    ax = axes[6]
    ploter(ax, history["F_cat"], label="Fcat",style='step', 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ploter(ax, history["effective_cat"], label="Fcat", style='step', 
                        time_converter=lambda t: t/3600.) # seconds to hours
    ...
    # Pressure
    ax = axes[5]
    ploter(ax, history["pressure"], label="Pressure",
    ...
    ax.legend(lns1, labs1, loc="best")
        ...
        # Pressure
    ax = axes[7]
    ploter(ax, history["monomer_rates"], label="monomer rate",
                        time_converter=lambda t: t/3600., array_index=0) # seconds to hours
    ploter(ax, history["monomer_rates"], label="comonomer rate",

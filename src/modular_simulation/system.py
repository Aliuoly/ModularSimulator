...
class System(ABC):
    ...
    def _update_history(self) -> None:
        ...
        hist_dict = self.measurable_quantities.states.model_dump()
        hist_dict.update(self.measurable_quantities.control_elements.model_dump())
        if self.measurable_quantities.algebraic_states:
            hist_dict.update(self.measurable_quantities.algebraic_states.model_dump())
        self._history += [hist_dict]
    ...
    def _pre_integration_step(self) -> NDArray:
        ...
        """
        usable_results = self.usable_quantities.update(self.measurable_quantities)
